    ...
    >
      {socials.map((social, index) => (
        <a
          ...
          className={cn(
            "relative cursor-pointer px-5 py-2 transition-opacity duration-200 no-underline",
        ...
        >
          <span className="block text-[11px] font-bold uppercase tracking-[0.3em] text-white/40 hover:text-primary transition-colors duration-200">
            {social.name}
          </span>
          <AnimatePresence>
